...
public class PayrollServicesImpl implements PayrollServices {
	...
	public int acceptAssociateDetails(String firstName, String lastName, String emailId, String department,
		...
		Associate associate = new Associate(yearlyInvestementUnder80C, accountNumber, firstName, lastName, department, designation, pancard, emailId, new BankDetails(accountNumber, bankName, ifscCode), new Salary(basicSalary, epf, companyPf)); 
